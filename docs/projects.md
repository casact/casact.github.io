...
[casact GitHub organization](https://github.com/casact). The table below is the
complete, unfiltered inventory, refreshed daily from the GitHub API. If you are
looking for a tool to solve a particular problem rather than for a specific
repository, the [Field Guide](field-guide.md) groups these projects by
functional area and sets them alongside the wider R, Python, and Julia
ecosystems.

<!-- REPOS:START -->
<!-- Generated by scripts/generate_repo_listings.py - do not edit by hand. -->

All 46 public repositories in the [casact GitHub organization](https://github.com/casact), fetched directly from the GitHub API.
