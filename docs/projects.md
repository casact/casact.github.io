...
[casact GitHub organization](https://github.com/casact). The Area column says
which part of actuarial work each project serves, so you can find one by the
problem it solves rather than by its name.

<!-- REPOS:START -->
<!-- Generated by scripts/generate_repo_listings.py - do not edit by hand. -->

All 46 public repositories in the [casact GitHub organization](https://github.com/casact), fetched directly from the GitHub API, except the areas of practice, which come from [a data file the working group maintains by hand](https://github.com/casact/casact.github.io/blob/main/docs/_data/repo_areas.csv).
...
<tr>
  ...
  <td class="cas-repo-area">Reserving</td>
  ...
  <td><span class="cas-repo-stat"><i class="fa-solid fa-star"></i> 279</span></td>
  <td><span class="cas-repo-stat"><i class="fa-solid fa-code-fork"></i> 115</span></td>
  <td>2017 Jun</td>
</tr>
<tr>
  ...
  <td><span class="cas-repo-lang"><span class="cas-lang-dot" style="background-color:#3572A5"></span>Python</span></td>
  <td><span class="cas-repo-stat"><i class="fa-solid fa-star"></i> 58</span></td>
...
<tr>
  ...
  <td class="cas-repo-area">Data and datasets</td>
  <td>Property Casualty Data Model Specification</td>
  <td><span class="cas-repo-lang"><span class="cas-lang-dot" style="background-color:#3572A5"></span>Python</span></td>
  <td><span class="cas-repo-stat"><i class="fa-solid fa-star"></i> 38</span></td>
...
<tr>
  ...
  <td><span class="cas-repo-stat"><i class="fa-solid fa-code-fork"></i> 13</span></td>
  <td>2021 May</td>
</tr>
<tr>
  ...
  <td class="cas-repo-area">Simulation and synthetic data</td>
...
<tr>
  ...
  <td class="cas-repo-area">Consumer tools</td>
...
<tr>
  ...
  <td class="cas-repo-area">Pricing and rating</td>
...
<tr>
  ...
  <td class="cas-repo-area">Organization and site</td>
...
<tr>
  ...
  <td class="cas-repo-area">Credibility and experience rating</td>
...
<tr>
  ...
  <td class="cas-repo-area">Reinsurance</td>
...
<tr>
  ...
  <td class="cas-repo-area">Capital modeling</td>
  <td>CAS Monograph 15 - Introduction to Capital Modeling and Portfolio Management</td>
  <td><span class="cas-repo-lang"><span class="cas-lang-dot" style="background-color:#3D6117"></span>TeX</span></td>
  <td><span class="cas-repo-stat"><i class="fa-solid fa-star"></i> 7</span></td>
  <td><span class="cas-repo-stat"><i class="fa-solid fa-code-fork"></i> 2</span></td>
  <td>2025 Nov</td>
</tr>
<tr>
...
<tr>
  ...
  <td class="cas-repo-area">Economic scenarios</td>
  <td></td>
...
<tr>
  ...
  <td class="cas-repo-area">Learning and contributing</td>
...
<tr>
  ...
  <td class="cas-repo-area">Publishing and authoring</td>
...
<tr>
  ...
  <td class="cas-repo-area">Catastrophe modeling</td>
...
<tr>
  ...
  <td class="cas-repo-area">Machine learning</td>
